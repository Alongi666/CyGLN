...
if __name__ == '__main__':
    ...
    num_nodes, num_rels, train_list, valid_list, test_list, train_list_gloabl, valid_list_gloabl, test_list_global, train_times, valid_times, test_times= load_data_list(args.data)
    ...
    out_dim=100
    num_entites=82999
    Net=Model(num_entites, h_dim, out_dim, num_rels)
    out=Net(graph)
    print(graph.edata)

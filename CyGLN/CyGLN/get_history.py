...
all_data, all_times = load_all_quadruples('./RE-GCN/data/{}'.format(args.dataset), 'train.txt', 'valid.txt', "test.txt")
num_e, num_r = get_total_number('./RE-GCN/data/{}'.format(args.dataset), 'stat.txt')

save_dir_obj = './RE-GCN/data/{}/history/'.format(args.dataset)
...
for tim in tqdm(all_times):
    ...
    sp.save_npz('./RE-GCN/data/{}/history/tail_history_{}.npz'.format(args.dataset, tim), tail_seq)
    sp.save_npz('./RE-GCN/data/{}/history/rel_history_{}.npz'.format(args.dataset, tim), rel_seq)
